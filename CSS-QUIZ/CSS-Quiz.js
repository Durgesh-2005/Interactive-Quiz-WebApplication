...
const quizData = {
  question1: '1. What is the full form of CSS?',
  options1: ['Cascading Style Sheets', 'Cascaded Style Sheets', 'Cascading Sheet Styles', 'None of the Above'],
  correctOptionIndex1: 0,

  question2: '2. Which property is used to change the text color in CSS?',
  options2: ['text-style', 'font-color', 'color', 'text-color'],
  correctOptionIndex2: 2,

  question3: '3. How can you group multiple CSS selectors together to apply the same styles to all of them?',
  options3: ['Using a comma', 'Using a plus (+) sign', 'Using an asterisk (*)', 'Using a hash (#) sign'],
  correctOptionIndex3: 0,

  question4: '4. Which CSS property is used to add space between the element\'s border and its content?',
  options4: ['margin', 'padding', 'border', 'space'],
  correctOptionIndex4: 1,

  question5: '5. What is the default value of the position property in CSS?',
  options5: ['fixed', 'relative', 'absolute', 'static'],
  correctOptionIndex5: 3,

  question6: '6. How do you make a list with bullets in CSS?',
  options6: ['list-type: bullets;', 'list-style-type: circle;', 'list-style: bullets;', 'list-type: circle;'],
  correctOptionIndex6: 1,

  question7: '7. Which property is used to control the transparency of an element in CSS?',
  options7: ['opacity', 'transparent', 'visibility', 'display'],
  correctOptionIndex7: 0,

  question8: '8. What does CSS stand for?',
  options8: ['Computer Style Sheets', 'Cascading Style Sheets', 'Colorful Style Sheets', 'Creative Style Sheets'],
  correctOptionIndex8: 1,

  question9: '9. How can you apply CSS styles to a specific media type, such as print or screen?',
  options9: ['media-type', '@media', 'style-media', 'css-media'],
  correctOptionIndex9: 1,

  question10: '10. Which property is used to set the background color of an element?',
  options10: ['background-color', 'bgcolor', 'background-style', 'color-background'],
  correctOptionIndex10: 0,
};
